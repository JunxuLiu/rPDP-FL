...
from myopacus.layers.dp_rnn import RNNLinear

# deprecated `functorch.make_functional()` # avaliable within PyTorch 1.x
...
# from torch.func import grad, vmap # avaliable within PyTorch 2.x
