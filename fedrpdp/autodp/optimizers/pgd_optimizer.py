...
def make_optimizer_class(cls):
    class PGDOptimizerClass(cls):
        ...
        def zero_microbatch_grad(self):
            super(PGDOptimizerClass, self).zero_grad()
        ...
        def step(self, minibatch_size=None, *args, **kwargs):
            ...
            super(PGDOptimizerClass, self).step(*args, **kwargs)

    return PGDOptimizerClass
