...
class PrivacyEngine:
        ...
        *,
        ...
        if poisson_sampling:
            return DPDataLoader.from_data_loader(
                data_loader, 
                generator=self.secure_rng, 
                sample_rate = self.sample_rate, distributed=distributed
            )
    ...
    def make_private(
        ...
        *,
        ...
        expected_batch_size = max(1, int(sum(self.sample_rate)))
    ...
    def get_epsilon(self,
        ...
        return self.accountant.get_epsilon(
            sample_rate = self.sample_rate[sample_id], 
            delta=target_delta)
...
# ===================
    ...
    def make_private_with_personalization(
        ...
        *,
        ...
        # self.outer_rounds = kwargs['outer_rounds']
        ...
        #                                           plot=False)
        assert self.sample_rate_fn is not None, "sample_rate_fn should not be None when pers_rdp is enabled."
