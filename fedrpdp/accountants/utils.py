...
def get_noise_multiplier(
    ...
    **kwargs,
    ...
    if accountant == "rdp":
        ...
        accountant.num_steps = steps
    else:
        # TODO: implement other accountants
        pass
    ...
    while eps_high > target_epsilon:
        ...
        accountant.noise_multiplier = sigma_high
    ...
    while target_epsilon - eps_high > epsilon_tolerance:
        ...
        accountant.noise_multiplier = sigma
...
# Author : Junxu Liu
def get_noise_multiplier_fed(
    *,
    target_epsilon: float,
    target_delta: float,
    inner_sample_rate: float,
    inner_steps: Optional[int],
    outer_sample_rate: float = None,
    outer_rounds: Optional[int] = None,
    accountant: str = "rdp",
    epsilon_tolerance: float = 0.01,
    **kwargs,
) -> float:
    ...
    if accountant == "rdp":
        accountant = create_accountant(mechanism="rdp",
                                       ...
                                       client_rate = outer_sample_rate)
        accountant.num_steps = outer_rounds
    else:
        # TODO: implement other accountants
        pass
