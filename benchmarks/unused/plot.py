...
log_path = './mnist/runs/'
# methods = ['privacy_free', 'ours', 'filter', 'WeakForAll', 'StrongForAll']
methods = ['privacy_free', 'ours', 'filter']
num_epochs = 100

kv_pairs = dict()
val_names = ['Acc/test', 'Loss/test']
all_results = dict()
...
plt.savefig(log_path+'heart_disease_sgd.pdf', dpi=500, bbox_inches='tight')