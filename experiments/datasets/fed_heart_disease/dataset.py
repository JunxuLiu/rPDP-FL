...
from configs.config_utils import check_dataset_from_config
...
class FedHeartDisease(Dataset):
    ...
    def __init__(
        ...
        chosen_centers = [center]
        if pooled:
            chosen_centers = [0, 1, 2, 3]
        ...
        to_select = [
            (rawdata.sets[idx] == chosen_sets)
            and (rawdata.centers[idx] in chosen_centers)
